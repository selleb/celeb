      ...
      <div className='aboutus__info'>
        <div className="aboutus__text">
          ...
          <p className="aboutus__p">
            We are an international company that partner with  well known celebrities  <br />   We do this in other to procure thier services for majority of the masses <br />
